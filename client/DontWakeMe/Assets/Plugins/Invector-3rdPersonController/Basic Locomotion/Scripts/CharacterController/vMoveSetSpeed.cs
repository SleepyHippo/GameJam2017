...
public class vMoveSetSpeed : MonoBehaviour
{
    ...
    private vExtraSpeed defaultFree = new vExtraSpeed();
    private vExtraSpeed defaultStrafe = new vExtraSpeed();

    public List<vExtraSpeed> listFree;
    public List<vExtraSpeed> listStrafe;
    ...
    void ChangeSpeed()
    {
        ...
        if (strafing)
        {
            ...
            if(extraSpeed != null)
            {
                ...
                cc.strafeRunningSpeed = extraSpeed.sprintSpeed;
