...
namespace Invector.CharacterController
{
    public class vThirdPersonController : vThirdPersonAnimator
    {
        ...
        public virtual void Jump()
        {
            ...
            bool staminaConditions = currentStamina > 30f;
            ...
            if (speed < 0.1f)
	            ...
	            animator.CrossFade("JumpMove", 0.1f);
        ...
        public virtual void Roll()
        {
            ...
            bool staminaCondition = currentStamina > 25f;
        ...
        {
            var diferenceRotation = referenceTransform.eulerAngles.y - transform.eulerAngles.y;
            ...
            if (diferenceRotation < -2.5) eulerY = referenceTransform.eulerAngles.y;
            else if ((diferenceRotation > 2.5)) eulerY = referenceTransform.eulerAngles.y;
        ...
        public virtual void TriggerAction(vTriggerAction triggerAction)
        {
            ...
            {
                // play the animation
                animator.CrossFade(triggerAction.playAnimation, 0.1f);
            }
        }
        ...
        {           
            ...
            transform.rotation = rot;            
            // play the animation
            animator.CrossFade(ladderAction.enterAnimation, 0.1f);
        }
